package com.iskech.elastic.canal;
...
import com.iskech.elastic.util.BinlogHelper;
    ...
    private  void printEntry(List<CanalEntry.Entry> entrys) {
        for (CanalEntry.Entry entry : entrys) {
            ...
            try {
                ...
                List<Binlog> binlog = BinlogHelper.coverCanalToBinlog(rowChage, City.class);
                canalBinlogBaseConsumer.onMessage(JSON.toJSONString(binlog.get(0)));
            } catch (Exception e) {
